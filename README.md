# ansible-pull repo for syslog-ng client.

This repository is used by **ansible-pull** run from the script **post_install.sh** in the iocage plugin [ansible-pull-syslogng-client](https://github.com/vbotka/iocage-plugins).
